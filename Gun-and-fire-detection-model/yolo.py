...
parser.add_argument('--image_path', help="Path of image to detect objects", default="videos/1.jpg")
...
def load_yolo():
	...
	output_layers = [layers_names[199], layers_names[226], layers_names[253]]
...
def draw_labels(boxes, confs, class_ids, classes, img):
	...
	for i in range(len(boxes)):
		if i in indexes:
			...
			color = [234.88662619, 130.99918685, 83.37200006]
